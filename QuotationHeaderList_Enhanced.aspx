        ...
        <div class="main-content">
            ...
            <div class="grid-container">
                <asp:GridView ID="OrderHeaderGrid" runat="server" DataMember="QuotationHeader" OnRowDataBound="OrderHeaderGrid_RowDataBound" DataSourceID="DBDataSource1"
                    ...
                    <Columns>
                        <ctls:ChildLinkField ImageUrl="~/images/edit.gif" TargetUrl="QuotationHeaderDetail.aspx">
                            <ItemStyle Width="50px" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <button class="action-btn edit-btn" type="button" title="Edit Quotation" data-toggle="tooltip">
                        ...
                        <asp:TemplateField HeaderText="Revise" ShowHeader="False" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px">
                            <ItemTemplate>
                                <asp:Button runat="server" CssClass="action-btn revise-btn" title="Revise Quotation" data-toggle="tooltip"
                                    CommandArgument='<%# Eval("OrderNumber").ToString() + "," + Eval("RevisedNumber").ToString()%>' 
                                    OnCommand="btnReviseQuotation_Command" Text="&#xf044;" />
                            </ItemTemplate>
                        </asp:TemplateField>

                        <ctls:ChildLinkField ImageUrl="~/images/return.gif" TargetUrl='../../SqlServerReports/QuotationFileAttachemnt.aspx' Target="_blank">
                            <ItemStyle Width="50px" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <button class="action-btn attach-btn" type="button" title="Attachments" data-toggle="tooltip">
                        ...
                        <ctls:ChildLinkField ImageUrl="~/images/print.gif" TargetUrl='../../reports/DocQuotation.aspx' HeaderText="SQ" Target="_blank">
                            <ItemStyle Width="50px" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <button class="action-btn print-btn" type="button" title="Print Quotation" data-toggle="tooltip">
                        ...
                        <ctls:ChildLinkField ImageUrl="~/images/print.gif" TargetUrl='../../reports/DocQuotationSpecs.aspx' HeaderText="SQ Specs" Target="_blank">
                            <ItemStyle Width="50px" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <button class="action-btn print-btn" type="button" title="Print Specifications" data-toggle="tooltip">
                        ...
                        <ctls:ChildLinkField ImageUrl="~/images/print.gif" HeaderText="Stock" TargetUrl='../../NewASPXReports/NewQuotationAndOrderStockReport.aspx?Type=Quotation' Target="_blank">
                            <ItemStyle Width="50px" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <button class="action-btn stock-btn" type="button" title="Stock Report" data-toggle="tooltip">
                        ...
                        <ctls:ChildLinkField ImageUrl="~/images/followup.png" HeaderText="Update" TargetUrl='QuotationFollowup.aspx' Target="_blank">
                            <ItemStyle Width="50px" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <button class="action-btn update-btn" type="button" title="Follow Up" data-toggle="tooltip">
                        ...
                        <ctls:ChildLinkField ImageUrl="~/images/Whatsapp.png" TargetUrl='WhatsappForQuot.aspx' HeaderText="W.A" Target="_blank">
                            <ItemStyle Width="50px" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <button class="action-btn whatsapp-btn" type="button" title="WhatsApp" data-toggle="tooltip">
                        ...
                        <asp:TemplateField HeaderText="Order" ShowHeader="False" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px">
                            <ItemTemplate>
                                <asp:Button runat="server" CssClass="action-btn order-btn" title="Convert to Order" data-toggle="tooltip"
                                    CommandArgument='<%# Eval("OrderNumber").ToString() + "," + Eval("RevisedNumber").ToString()%>' 
                                    OnCommand="btnConvertToOrder_Command" Text="&#xf1c0;" />
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Close" ShowHeader="False" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px">
                            <ItemTemplate>
                                <asp:Button runat="server" CssClass="action-btn close-btn" title="Close Quotation" data-toggle="tooltip"
                                    CommandArgument='<%# eval("OrderNumber") %>' OnCommand="btnClose_Command" Text="&#xf00d;" />
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Copy" ShowHeader="False" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px">
                            <ItemTemplate>
                                <asp:Button runat="server" CssClass="action-btn copy-btn" title="Copy Quotation" data-toggle="tooltip"
                                    CommandArgument='<%# Eval("OrderNumber").ToString() + "," + Eval("RevisedNumber").ToString()%>' 
                                    OnCommand="btnCopyQuotation_Command" Text="&#xf0c5;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="For Approval" ShowHeader="False" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px" Visible="false">
                            <ItemTemplate>
                                <asp:Button runat="server" CssClass="action-btn" title="Send for Approval" data-toggle="tooltip"
                                    CommandArgument='<%# Eval("OrderNumber") %>' OnCommand="btnApproval_Command" Text="&#xf0c7;" />
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="T & S" ShowHeader="False" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80px">
                            <ItemTemplate>
                                <asp:Button ID="btnTicketAndSelect" runat="server" CssClass="action-btn ticket-btn" title="Tick & Select" data-toggle="tooltip"
